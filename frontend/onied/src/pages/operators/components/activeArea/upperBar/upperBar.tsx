...
const Return = () => {
    ...
    return <div className={classes.buttonSvg} onClick={clickEvent}>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.33334 8.33333L3.03871 8.628L2.74408 8.33333L3.03871 8.03871L3.33334 
            ...
            17.0833 13.3333H16.25C16.25 10.802 14.198 8.75 11.6667 8.75V7.91667Z" fill="#9715D3" />
        </svg>
    </div>
}
    ...
    return <div className={classes.buttonSvg} onClick={clickEvent}>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_1660_571)">
                <path d="M1.12062 8.8299C-0.372645 7.33664 -0.372645 4.90691 1.12062 3.41297L3.41266 
                ...
                13.2823L0.651385 12.3579L0.30514 13.6506L3.74754 14.5737L4.09445 13.2823Z" fill="#9715D3" />
            </g>
            <defs>
    ...
    return <div className={classes.buttonSvg} onClick={clickEvent}>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_1660_575)">
                <path d="M19.375 0.625C19.0298 0.625 18.75 0.904844 18.75 1.25V1.875H1.25V1.25C1.25 
                ...
                9.375V6.25H13.125V9.375H10V6.25H6.875V9.375H3.75V6.25H1.25V3.125H3.75V6.25H6.875V3.125H10V6.25H13.125V3.125H16.25V6.25H18.75V9.375H16.25Z" fill="#9715D3" />
