...
export default function SendMessageFooter() {
    ...
    return <div className={classes.chatFooter}>
        <InputFormArea onInput={(e: any) => setMessage(e.target.value)}
...
const SendButton = ({ onClick }: { onClick?: MouseEventHandler }) => {
    return (
        <svg className={classes.sendButton} onClick={onClick} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="40" height="40" rx="20" fill="#9715D3" />
            <path d="M12.71 14.2706L24.03 10.4973C29.11 8.80396 31.87 11.5773 30.19 
            ...
            <path d="M16.3233 24.0441L21.0967 19.2574" stroke="white"
