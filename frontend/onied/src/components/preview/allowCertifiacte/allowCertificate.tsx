...
function AllowCertificate(): ReactNode {
    ...
    <div className={classes.allowCertificate}>
        <svg width="50" height="50" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M11.875 15L13.9583 17.0833L18.125 12.9167M15 5.625L16.9897 7.57445L19.6875 
            ...
            stroke="#686868" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
