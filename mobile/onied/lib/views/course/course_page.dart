...
class CoursePage extends StatefulWidget {
  ...
  State<CoursePage> createState() => _CoursePageState(id: id); // TODO: rewrite to stateless widget
}

class _CoursePageState extends State<CoursePage> {
  final String id;

  _CoursePageState({required this.id});
    ...
    'modules': [
      ...
      },
      {
        ...
        'blocks': [
          ...
          {
            'id': 5,
            'title': 'Заголовок блока с виде',
            'blockType': 2,
            'index': 1,
            'href': 'https://vkvideo.ru/video-48265019_456243841',
          },
          {
            'id': 6,
            'title': 'Заголовок блока с заданиями',
