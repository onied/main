...
public class PurchaseMakingServiceTests
{
    ...
    private readonly PurchaseMakingService _service;
    ...
    public PurchaseMakingServiceTests()
    {
        ...
        _service = new PurchaseMakingService(
            _mockMapper.Object,
    ...
    public async Task GetCoursePreparedPurchase_CourseNotFound_ReturnsNotFound()
    {
        ...
        var result = await _service.GetCoursePreparedPurchase(1);
    ...
    public async Task MakeCoursePurchase_ValidationFails_ReturnsErrorResult()
    {
        ...
        var result = await _service.MakeCoursePurchase(dto, Guid.NewGuid());
    ...
    public async Task GetCertificatePreparedPurchase_CertificateNotFound_ReturnsNotFound()
    {
        ...
        var result = await _service.GetCertificatePreparedPurchase(1);
    ...
    public async Task MakeCertificatePurchase_ValidationFails_ReturnsErrorResult()
    {
        ...
        var result = await _service.MakeCertificatePurchase(dto, Guid.NewGuid());

        Assert.IsType<BadRequest<string>>(result);
    }

    [Fact]
    public async Task MakeCertificatePurchase_ValidationPasses_ReturnsOk()
    {
        var dto = new PurchaseRequestDto(
            It.IsAny<Guid>(),
            It.IsAny<decimal>(),
    ...
    public async Task GetSubscriptionPreparedPurchase_SubscriptionNotFound_ReturnsNotFound()
    {
        ...
        var result = await _service.GetSubscriptionPreparedPurchase(1);
    ...
    public async Task GetSubscriptionPreparedPurchase_SubscriptionFreePurchaseAttempt_ReturnsForbid()
    {
        ...
        var result = await _service.GetSubscriptionPreparedPurchase((int)SubscriptionType.Free);
    ...
    public async Task GetSubscriptionPreparedPurchase_SubscriptionFound_ReturnsOk()
    {
        ...
        var result = await _service.GetSubscriptionPreparedPurchase(2);
    ...
    public async Task MakeSubscriptionPurchase_ValidationFails_ReturnsErrorResult()
    {
        ...
        var result = await _service.MakeSubscriptionPurchase(dto, Guid.NewGuid());

        Assert.IsType<BadRequest<string>>(result);
    }

    [Fact]
    public async Task MakeSubscriptionPurchase_ValidationPasses_ReturnsOk()
    {
        var dto = new PurchaseRequestDto(
            It.IsAny<Guid>(),
            It.IsAny<decimal>(),
