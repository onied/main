...
public class CourseCreateFailedConsumer(ICourseRepository courseRepository, ILogger<CourseCreateFailedConsumer> logger)
    : IConsumer<CourseCreateFailed>
{
    public async Task Consume(ConsumeContext<CourseCreateFailed> context)
    {
        ...
        await courseRepository.RemoveAsyncById(context.Message.Id);
    }
}
